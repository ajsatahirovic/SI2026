    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsForSale = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
                    ...
                    IsForRent = table.Column<bool>(type: "tinyint(1)", nullable: true, defaultValue: false),
                    PriceRentPerDay = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__3214EC075CD4A033", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__3214EC07E2671596", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__3214EC076927A3B3", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true, defaultValue: "Pending")
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reservat__3214EC07871BD7D2", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Reservati__Produ__48CFD27E",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderIte__3214EC07FDA813DD", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D10534F32A7C51",
                table: "Users",
                column: "Email",
                unique: true);
        }
